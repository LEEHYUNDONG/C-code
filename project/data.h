...
void Sign_up(struct info *arr, int *pnum) 
{
        ...
        {          
            printf("Name : ");
            fgets(arr[*pnum].name, 20,stdin);
                                
            printf("Id : ");
            fgets(arr[*pnum].id, 20,stdin);
            printf("Password : ");
            fgets(arr[*pnum].psw, 20, stdin);                                    
            printf("School : ");
            fgets(arr[*pnum].sch, 20 ,stdin);
                                                                    
            printf("City : ");
            fgets(arr[*pnum].city, 20, stdin);
            
            printf("Age : "); 
            gets(arr[*pnum].age, 20, stdin);
            (*pnum)++;
        }
        else
        printf("User is Full\n");
